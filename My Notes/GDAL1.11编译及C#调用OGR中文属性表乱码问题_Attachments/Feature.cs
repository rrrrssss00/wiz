...
public class Feature : IDisposable {
  ...
  public string GetFieldAsString(int id) {
        ...
        string ret = Ogr.LocalBytesToString(cPtr);
  ...
  public void SetField(int id, string value) {
    OgrPINVOKE.Feature_SetField__SWIG_0(swigCPtr, id, Ogr.StringToLocalBytes(value));
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetField(string name, string value) {
    OgrPINVOKE.Feature_SetField__SWIG_1(swigCPtr, name, Ogr.StringToLocalBytes(value));
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
  }
